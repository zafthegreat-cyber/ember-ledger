...
Phase 2C-A is published at `3b10644cf1be9498c08b876b5a3bbef98a24ee1c`, Phase 2C-B at `bcff80042a15a29492ed32ba945291b50d35b5bb`, and Phase 2C-C at `ef30033a3b30989737878252fb31354aaecf68a3`. Phase 2C-D is the current local-only candidate: it preserves immutable Sale and Transfer history while adding explicit reviewed, append-only COGS/product/provenance reconciliation projections. It does not connect Inbox/Order or Bot evidence, infer a return from a refund, create replacement/extra Inventory automatically, begin Raw/Graded authority, resume Phase 2B2-B.1, activate remote persistence, or deploy Production.
...
## Phase 2C-B through Phase 2C-D owner-confirmed Inventory delta
...
| Purchase, Receiving, Inventory creation, correction, and reconciliation | OWNER-gated Purchase Draft/Purchase/Receiving, derived handoff/candidate review, explicit Inventory confirmation, preview-first append-only correction/disposition, and immutable-history COGS/Sale reconciliation into the existing local Business Inventory | `src/features/purchaseReceiving`, `src/features/flipScout`, `src/pages/EverydayWorkspaces.jsx` | `LOCAL_ONLY`; original Sales/Transfers remain immutable; refund is not return; transfer modes remain blocked without managed authority; no upstream auto-import, automatic product creation, remote adapter, or canonical-schema use |
