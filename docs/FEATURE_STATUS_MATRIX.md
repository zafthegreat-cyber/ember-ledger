...
Published Phase 2C-C baseline: `ef30033a3b30989737878252fb31354aaecf68a3`. Phase 2C-D is the current local-only historical COGS/Sale/Transfer reconciliation candidate. It adds no automatic evidence import, destructive Sale/Transfer edit, refund-to-return inference, automatic replacement/extra Inventory, Raw/Graded authority, remote persistence, executed schema, migrated owner record, connected email/Inbox/Orders/Bot provider, live Bot control, checkout, billing, AI/computer-vision provider, or autonomous retailer/marketplace action. The separate Phase 2B2-B.1 operational verification remains paused; `hostedRuntimeVerified=false`.
