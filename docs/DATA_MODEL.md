...
### Phase 2C-B creation and Phase 2C-C correction/disposition records
...
The existing Flip Scout/Business Inventory document retains storage key `ember-and-tide.flip-scout.v1`. Phase 2C-C advances it to schema version 4 without adding another Inventory authority or collection:
