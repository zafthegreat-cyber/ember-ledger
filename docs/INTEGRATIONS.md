...
| Historical COGS/Sale reconciliation | AVAILABLE_LOCAL_ONLY | Phase 2C-D candidate/reconciliation gateway and derived reporting projections | explicit owner review of exact signed COGS/product/cost effect while original Sale remains immutable | no broad accounting ledger; original Sale dates and reconciliation timestamps remain distinct; dedicated prior-period accounting and server transaction/multi-device authority remain future | Phase 2C-D local candidate |
