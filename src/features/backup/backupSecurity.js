const PROHIBITED_NORMALIZED_KEYS = new Set([
  ...
  "inventorycreationcommitjournal",
  ...
  "inventoryreconciliationjournal",
  "supabasesession",
...
const PROHIBITED_STORAGE_KEY_PATTERNS = [
  ...
  /(?:^|[.:-])invite-token(?:$|[.:-])/i,
  /^et-tcg-admin-mode:/i,
  /inventory-(?:creation|correction|reconciliation)-commit-journal/i,
];
...
export const SECURITY_EXCLUSION_SUMMARY = Object.freeze([
  ...
  "Purchase/Receiving payment, retailer-authentication, raw evidence, and derived Inventory handoff/candidate data",
  "Ephemeral Inventory creation, correction, and historical-reconciliation previews/candidates plus private recovery journals",
]);
