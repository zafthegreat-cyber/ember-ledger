...
export const PRODUCT_ALIAS_RULES = [
  ...
  productRule("Tech Sticker Collection", ["tech sticker", "tech sticker collection", "sticker collection"], "tech_sticker_collection", 95),
  productRule("Surprise Box", ["surprise box"], "surprise_box", 90),
