...
-- Extend the existing per-user product catalog so it can hold API-imported Pokemon cards and sealed products.
alter table public.product_catalog
  ...
  add column if not exists last_price_checked timestamptz,
...
-- Virginia Pokemon retailer/location table.
