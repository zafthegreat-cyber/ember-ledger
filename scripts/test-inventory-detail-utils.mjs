...
assert.match(appSource, /return "booster-box";/);
assert.match(appSource, /return "pack";/);
assert.match(appSource, /tin: "Tin"/);
assert.match(appSource, /bundle: "Bundle"/);
assert.match(appSource, /pack: "Pack"/);
assert.match(appSource, /"booster-box": "Booster Box"/);
...
assert.match(appSource, /Image not available|No image|collector-showcase-card--fallback/);
assert.match(appSource, /Check details manually/);
